...
const StatsScreen = () => {
    ...
    return (
        ...
        <div>
            ...
            <div style={{ marginTop: 80, flexDirection: 'column-reverse', display: 'flex' }}>
                                ...
                                <Col>
                                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                        <Typography variant='subtitle2'
                                            ...
                                            {/* {e.value.sad < 60 ? (e.value.sad/60 + "hrs ") : (Math.round(e.value.sad/60) + "hrs ")} */}
                                            {Math.round((e.value.sad / 60) * 100 / ((e.value.happy / 60) + (e.value.sad / 60))) + "% "}
                                        </Typography>
                                ...
                                <Col>
                                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                        <Typography variant='subtitle2'
                                            ...
                                            {Math.round((e.value.happy / 60) * 100 / ((e.value.happy / 60) + (e.value.sad / 60))) + "% "}
